...
<html dir="ltr" xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" lang="en" style="font-family:arial, 'helvetica neue', helvetica, sans-serif">
 <head>
  ...
  <title>Thank you for contacting Yesil Services</title><!--[if (mso 16)]>
    <style type="text/css">
                     ...
                     <tr>
                      <td align="left" style="padding:0;Margin:0;padding-top:5px;padding-bottom:5px">
                        <p style="Margin:0;margin-bottom: 25px; -webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'Josefin Sans', helvetica, arial, sans-serif;line-height:21px;color:#38363A;font-size:16px">
                            ...
                            We are thrilled to thrilled to receive your inquiries on our services.
                            <br>
                            We are working on your inquiry and we will get back to your in a short while.
                            <br>
                            <br>
                            Should you have any questions or need further information, please reach out to us  at <a style="color: #02395C;" href="tel:2347040256707">+234 704 025 6707</a>, <a style="color: #02395C;" href="tel:2347064325371">+234 706 432 5371</a>
                        </p>
                        <p style="color: #02395C; Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'Josefin Sans', helvetica, arial, sans-serif;line-height:21px;font-size:16px">
                            Best Regards, <br>
                            Yesil Services.
                        </p>
                    </td>
        ...
        <tr>
         <td align="center" style="padding:0;Margin:0">
          <table bgcolor="#ffffff" class="es-content-body" align="center" cellpadding="0" cellspacing="0" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#FFFFFF;width:600px">
            <tr>
             <td align="left" bgcolor="#222222" style="Margin:0;padding-left:20px;padding-right:20px;padding-top:2px;padding-bottom:2px;background-color:#1D0D35">
            </td>
            </tr>
          </table></td>
        </tr>
